...
<!--partie 2-->
    ...
    <div class="col-md-9">
                                <div class="nav-tabs-custom">
                                    <form action="removeclientbase.php" method="_POST">
                                    <ul class="nav nav-tabs">

                                        <li><a href="#settings" data-toggle="tab">Remove Client</a></li></br>
                                    </ul>
                                    ...
                                    <div class="tab-pane" id="settings">
                                        <form class="form-horizontal">
                                            <div class="form-group">
                                                <label for="inputName" class="col-sm-2 control-label">id_client</label>

                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="id_client" placeholder="id_client">
                                                </div>
                                            </div>
