...
<!--partie 2-->
    ...
    <div class="col-md-9">
                                <div class="nav-tabs-custom">
                                    <form action="addproductbase.php" method="_POST">
                                    <ul class="nav nav-tabs">

                                        <li><a href="#settings" data-toggle="tab">Add Product</a></li></br>
                                    </ul>
                                    ...
                                    <div class="tab-pane" id="settings">
                                        <form class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label for="inputEmail" class="col-sm-2 control-label">prix</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputEmail" class="col-sm-2 control-label">stock</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputEmail" class="col-sm-2 control-label">disponibilite</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputExperience" class="col-sm-2 control-label"> designation</label>
