...
<!--partie 2-->
    ...
    <div class="col-md-9">
                                <div class="nav-tabs-custom">
                                    <form action="addcatbase.php" method="_POST">
                                    <ul class="nav nav-tabs">

                                        <li><a href="#settings" data-toggle="tab">Add Category</a></li></br>
                                    </ul>
                                    ...
                                    <div class="tab-pane" id="settings">
                                        <form class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="nom" placeholder="Name of Category">
                                                </div>
                                            </div>
                                            <div class="form-group">
